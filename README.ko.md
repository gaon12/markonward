...
> 아닙니다. 고정된 공식 테스트에서 CommonMark 0.31.2는 652/652 전체를,
> 현재 추출 중인 GFM 0.29 기본 예제는 638/649를 통과합니다. GFM fixture
> gate에는 확장 예제도 포함하도록 보완 중입니다. 릴리스 워크플로는 100%를 요구하므로 현재
> `v1.0.0`을 배포할 수 없습니다.
