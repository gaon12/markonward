...
2026-07-21 로컬 최적화 실행에서는 대표 코퍼스의 byte와 allocation이 크게
낮았지만 오래된 공유 Windows 장비에서 시간 편차가 매우 컸습니다. 이를 안정된
홍보 수치로 사용하지 않습니다. 릴리스 workflow가 gate를 다시 실행하며 어떤
v1 tag도 이를 우회할 수 없습니다.
